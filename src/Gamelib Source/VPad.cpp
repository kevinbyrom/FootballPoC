...
int VPAD::Start()
	...
	return ((VStart.Key		!= VPAD_NONE && pInput->GetKey(VStart.Key)) ||
			(VStart.JButton != VPAD_NONE && pInput->GetJoyButton(Joy, VStart.JButton)));
	}
...
int VPAD::Select()
	...
	return ((VSelect.Key		!= VPAD_NONE && pInput->GetKey(VSelect.Key)) ||
			(VSelect.JButton	!= VPAD_NONE && pInput->GetJoyButton(Joy, VSelect.JButton)));
	}
...
int VPAD::LTrigger()
	...
	return ((VLTrigger.Key		!= VPAD_NONE && pInput->GetKey(VLTrigger.Key))				|| 
			(VLTrigger.MButton	!= VPAD_NONE && pInput->GetMouseButton(VLTrigger.MButton))	||
			(VLTrigger.JButton	!= VPAD_NONE && pInput->GetJoyButton(Joy, VLTrigger.JButton)));
	}
...
int VPAD::RTrigger()
	...
	return ((VRTrigger.Key		!= VPAD_NONE && pInput->GetKey(VRTrigger.Key))				|| 
			(VRTrigger.MButton	!= VPAD_NONE && pInput->GetMouseButton(VRTrigger.MButton))	||
			(VRTrigger.JButton	!= VPAD_NONE && pInput->GetJoyButton(Joy, VRTrigger.JButton)));
	}
...
int VPAD::Button(int btn)
	...
	return ((VButton[btn].Key		!= VPAD_NONE && pInput->GetKey(VButton[btn].Key))				|| 
			(VButton[btn].MButton	!= VPAD_NONE && pInput->GetMouseButton(VButton[btn].MButton))	||
			(VButton[btn].JButton	!= VPAD_NONE && pInput->GetJoyButton(Joy, VButton[btn].JButton)));
	}
...
int VPAD::ButtonClicked(int btn)
	...
	return ((VButton[btn].Key		!= VPAD_NONE && pInput->GetKeyClicked(VButton[btn].Key))				|| 
			(VButton[btn].MButton	!= VPAD_NONE && pInput->GetMouseButtonClicked(VButton[btn].MButton))	||
			(VButton[btn].JButton	!= VPAD_NONE && pInput->GetJoyButtonClicked(Joy, VButton[btn].JButton)));
	}
